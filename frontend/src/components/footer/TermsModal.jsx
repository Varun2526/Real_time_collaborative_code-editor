...
const TermsModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md" onClick={onClose}>
      <div 
        className="bg-black border border-[rgba(240,240,250,0.2)] p-8 max-w-2xl w-full max-h-[85vh] overflow-hidden flex flex-col rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative"
      ...
      >
        ...
        <h2 className="text-spacex-hero text-3xl mb-2 font-bold tracking-[2px]">TERMS OF SERVICE</h2>
        <p className="text-spacex-micro text-white/40 mb-8 font-bold">LAST UPDATED: MAY 11, 2026</p>
