      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col xl:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
          <div className="flex flex-wrap justify-center items-center gap-6">
            ...
            <a href="https://github.com/Varun2526/Real_time_collaborative_code-editor" target="_blank" rel="noreferrer" className="text-spacex-nav text-white/40 hover:text-white transition-colors uppercase">GITHUB</a>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4">
            ...
            <a href="https://www.linkedin.com/in/varun-koppula-b01916315/" target="_blank" rel="noreferrer" className="text-spacex-nav text-white/40 hover:text-white transition-colors uppercase">VARUN</a>
            <a href="https://www.linkedin.com/in/venkata-hareesh-kaza-72b237330/" target="_blank" rel="noreferrer" className="text-spacex-nav text-white/40 hover:text-white transition-colors uppercase">HAREESH</a>
            <a href="https://www.linkedin.com/in/nimishakavi-sri-nihal-723069271/" target="_blank" rel="noreferrer" className="text-spacex-nav text-white/40 hover:text-white transition-colors uppercase">NIHAL</a>
            <a href="https://www.linkedin.com/in/bollam-jayaram-aditya/" target="_blank" rel="noreferrer" className="text-spacex-nav text-white/40 hover:text-white transition-colors uppercase">JAYARAM</a>
            <a href="https://www.linkedin.com/in/nigama-vydyula-8554a83b6/" target="_blank" rel="noreferrer" className="text-spacex-nav text-white/40 hover:text-white transition-colors uppercase">NIGAMA</a>
