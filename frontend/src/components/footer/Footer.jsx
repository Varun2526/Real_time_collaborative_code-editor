      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col xl:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
          <div className="flex flex-wrap justify-center items-center gap-6">
            <Link to="/privacy-policy" className="text-spacex-nav text-[#0077b5]/80 hover:text-[#0077b5] transition-colors">PRIVACY POLICY</Link>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4">
            ...
            <a href="https://www.linkedin.com/in/bollam-jayaram-aditya/" target="_blank" rel="noreferrer" className="text-spacex-nav text-[#0077b5]/80 hover:text-[#0077b5] transition-colors">JAYARAM</a>
            <a href="https://www.linkedin.com/in/nigama-vydyula-8554a83b6/" target="_blank" rel="noreferrer" className="text-spacex-nav text-[#0077b5]/80 hover:text-[#0077b5] transition-colors">NIGAMA</a>
          </div>
        </div>
      </div>
    </footer>
